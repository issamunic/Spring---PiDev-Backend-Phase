...
public class CommentRestController {
	...
	@ApiOperation(value = "retrieve sentiment Pourcentages")
	@GetMapping("/retrieve-pourcentages")
	@ResponseBody
	public List<Double> retreiveSentimentPourcentages() {
		return comservice.PourcentageOfSentimentsLastWeek();
	}
